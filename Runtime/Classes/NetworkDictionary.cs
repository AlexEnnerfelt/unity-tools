...
namespace Unity.Netcode {
	...
	public class NetworkDictionary<TKey, TValue> : NetworkVariableBase, IDictionary<TKey, TValue>
		where TKey : unmanaged, IEquatable<TKey>
		where TValue : unmanaged {
		public struct Enumerator : IEnumerator<(TKey Key, TValue Value)>, IEnumerator<KeyValuePair<TKey, TValue>> {
			...
			KeyValuePair<TKey, TValue> IEnumerator<KeyValuePair<TKey, TValue>>.Current => new KeyValuePair<TKey, TValue>(Current.Key, Current.Value);
		...
		IEnumerator<KeyValuePair<TKey, TValue>> IEnumerable<KeyValuePair<TKey, TValue>>.GetEnumerator() => new Enumerator(ref m_Keys, ref m_Values);
